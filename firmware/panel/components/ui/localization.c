...
static const ui_translation_t s_translations[UI_STR_COUNT] = {
    ...
    [UI_STR_CERT_SECTION] = {"Certificats TLS", "TLS certificates", "Certificados TLS"},
    [UI_STR_CERT_STATUS_DEFAULT] = {"Certificat intégré (%u octets)", "Built-in certificate (%u bytes)",
                                    "Certificado integrado (%u bytes)"},
    [UI_STR_CERT_STATUS_CUSTOM] = {"Certificat personnalisé (%u octets)", "Custom certificate (%u bytes)",
                                   "Certificado personalizado (%u bytes)"},
    [UI_STR_CERT_STATUS_MISSING] = {"Aucun certificat disponible", "No certificate available",
                                    "Sin certificado disponible"},
    [UI_STR_CERT_PATH] = {"Fichier PEM", "PEM file", "Archivo PEM"},
    [UI_STR_CERT_IMPORT] = {"Importer certificat", "Import certificate", "Importar certificado"},
    [UI_STR_CERT_PROVISION] = {"Provision auto", "Auto provision", "Provisionar automáticamente"},
    [UI_STR_CERT_NO_PATH] = {"Chemin certificat manquant", "Certificate path missing", "Ruta de certificado faltante"},
    [UI_STR_CERT_AUTO_SWITCH] = {"Provision automatique", "Automatic provisioning", "Provisionamiento automático"},
    [UI_STR_CERT_IMPORTED] = {"Certificat TLS chargé", "TLS certificate loaded", "Certificado TLS cargado"},
    ...
    [UI_STR_ERROR_CERT] = {"Erreur certificat TLS", "TLS certificate error", "Error de certificado TLS"},
