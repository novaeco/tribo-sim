...
typedef enum {
    ...
    UI_STR_CERT_SECTION,
    UI_STR_CERT_STATUS_DEFAULT,
    UI_STR_CERT_STATUS_CUSTOM,
    UI_STR_CERT_STATUS_MISSING,
    UI_STR_CERT_PATH,
    UI_STR_CERT_IMPORT,
    UI_STR_CERT_PROVISION,
    UI_STR_CERT_NO_PATH,
    UI_STR_CERT_AUTO_SWITCH,
    UI_STR_CERT_IMPORTED,
    ...
    UI_STR_SENSOR_VALUE_UVI_EXT,
    UI_STR_SENSOR_VALUE_UVI_FAULT,
